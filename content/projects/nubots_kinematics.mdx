...
description: A pipeline to generate URDF file of NUgus robot from Onshape.
url: https://nubook.nubots.net/
repository: NUbots/NUbots
date: "2023-01-01"
published: true
media: /images/urdf.mp4
---
...
![Webots](/images/onshape-to-urdf.png "urdf")
...
The generated URDF file is used for forward and inverse kinematics, dynamics, and control algorithms leveraging the tinyrobotics library which can be here [NUbots](/projects/tinyrobotics)
