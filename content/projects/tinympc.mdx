---
title: tinympc
description: tinympc is a lightweight C++ library that implements general linear and non-linear model predictive control (MPC).
date: "2023-01-01"
url: https://github.com/Tom0Brien/tinympc
published: true
repository: tom0Brien/tinympc
media: /images/tinympc.png
---
