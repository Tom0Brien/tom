...
description: A vision module for detecting and estimating the Cartesian position of Balls, Goals, Robots, Field Intersections (X, L, T) using YoloV8n for the RoboCup competition.
url: https://nubook.nubots.net/
repository: NUbots/NUbots
date: "2023-01-01"
published: true
media: /images/yolo.mp4
---
